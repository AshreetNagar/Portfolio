			...
			<div className="max-w-4xl mx-auto">
				...
				>
					...
					<div className="relative z-10">
						...
						<div className="flex justify-end items-center gap-3 mb-6 text-gray-400">
							{/* Minimize */}
							<svg
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:ashreet14@gmail.com"
						...
						{/* GitHub */}
						<motion.a
							href="https://github.com/AshreetNagar"
						...
						>
							...
							<p className="text-sm text-gray-400">@AshreetNagar</p>
							</div>
						</motion.a>

						{/* LinkedIn */}
						<motion.a
							href="https://linkedin.com/in/ashreet-nagar"
							whileHover={{ scale: 1.05 }}
							className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
						>
							<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
							...
							<p className="text-sm text-gray-400">Ashreet Nagar</p>
							</div>
						</motion.a>
						</div>
